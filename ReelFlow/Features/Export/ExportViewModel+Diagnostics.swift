...
extension ExportViewModel {
    ...
    private func diagnosticsBundleRootURL() -> URL {
        ...
        return base
            .appendingPathComponent("ReelFlow/Diagnostics/Bundles", isDirectory: true)
    }
    ...
    private func exportFailureStatsURL() -> URL {
        ...
        return base
            .appendingPathComponent("ReelFlow/Diagnostics/export-failure-stats.json")
    }
    ...
    private func logsDirectoryURL() -> URL {
        ...
        return base
            .appendingPathComponent("ReelFlow/Logs", isDirectory: true)
    }
