...
extension ExportViewModel {
    func applyUITestScenarioIfNeeded() {
        ...
        case "success":
            ...
            lastSuccessfulOutputURL = URL(fileURLWithPath: "/tmp/ReelFlow-UI-Success.mp4")
            recoveryAdvice = nil
            failureCardCopy = nil
    ...
    func handleUITestRecoveryShortcutIfNeeded() -> Bool {
        ...
        lastSuccessfulOutputURL = URL(fileURLWithPath: "/tmp/ReelFlow-UI-Recovered.mp4")
        recoveryAdvice = nil
        failureCardCopy = nil
        workflow.finishExportSuccess(
    ...
    func simulateExportFailure() {
        ...
        let debugDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("ReelFlow-Debug", isDirectory: true)
